...
if(OHOS_LLVM)
  # OHOS_LOCAL: LoongArch crt needs -mcmodel=medium
...
if(APPLE)
  ...
  list_intersect(ORC_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  if(OHOS_LLVM)
    list_intersect(OHOS_MEMGRAPH_SUPPORTED_ARCH
      ALL_OHOS_MEMGRAPH_SUPPORTED_ARCH
      SANITIZER_COMMON_SUPPORTED_ARCH)
  endif()
  ...
  if(OHOS_LLVM)
    filter_available_targets(OHOS_MEMGRAPH_SUPPORTED_ARCH ${ALL_OHOS_MEMGRAPH_SUPPORTED_ARCH})
  endif()
...
if (SANITIZER_COMMON_SUPPORTED_ARCH AND NOT LLVM_USE_SANITIZER AND
    (OS_NAME MATCHES "Android|Darwin|Linux|FreeBSD|NetBSD|Fuchsia|SunOS|Haiku" OR
     (OHOS_LLVM AND OS_NAME MATCHES "OHOS") OR
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND HWASAN_SUPPORTED_ARCH AND
    (OS_NAME MATCHES "Linux|Android|Fuchsia" OR
     (OHOS_LLVM AND OS_NAME MATCHES "OHOS")))
...
if (OS_NAME MATCHES "Linux|FreeBSD|Windows|NetBSD|SunOS" OR
    (OHOS_LLVM AND OS_NAME MATCHES "OHOS"))
...
if (PROFILE_SUPPORTED_ARCH AND NOT LLVM_USE_SANITIZER AND
    (OS_NAME MATCHES "Darwin|Linux|FreeBSD|Windows|Android|Fuchsia|SunOS|NetBSD|AIX|WASI|Haiku" OR
     (OHOS_LLVM AND OS_NAME MATCHES "OHOS")))
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND TSAN_SUPPORTED_ARCH)
  if (OS_NAME MATCHES "Linux|Darwin|FreeBSD|NetBSD" OR
    (OHOS_LLVM AND OS_NAME MATCHES "OHOS"))
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND UBSAN_SUPPORTED_ARCH AND
    (OS_NAME MATCHES "Darwin|Linux|FreeBSD|NetBSD|Windows|Android|Fuchsia|SunOS|Haiku" OR
     (OHOS_LLVM AND OS_NAME MATCHES "OHOS")))
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND UBSAN_SUPPORTED_ARCH AND
    (OS_NAME MATCHES "Linux|FreeBSD|NetBSD|Android|Darwin" OR
     (OHOS_LLVM AND OS_NAME MATCHES "OHOS")))
...
if (SCUDO_STANDALONE_SUPPORTED_ARCH AND
    ...
    (OS_NAME MATCHES "Linux" OR
     (OHOS_LLVM AND OS_NAME MATCHES "OHOS")) AND
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND FUZZER_SUPPORTED_ARCH AND
    (OS_NAME MATCHES "Android|Darwin|Linux|NetBSD|FreeBSD|Fuchsia|Windows" OR
     (OHOS_LLVM AND OS_NAME MATCHES "OHOS")))
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND SHADOWCALLSTACK_SUPPORTED_ARCH AND
    (OS_NAME MATCHES "Linux|Android" OR
     (OHOS_LLVM AND OS_NAME MATCHES "OHOS")))
...
if (OHOS_LLVM AND OHOS_MEMGRAPH_SUPPORTED_ARCH AND
    COMPILER_RT_HAS_SANITIZER_COMMON AND OS_NAME MATCHES "OHOS")
  set(COMPILER_RT_HAS_OHOS_MEMGRAPH TRUE)
else()
  set(COMPILER_RT_HAS_OHOS_MEMGRAPH FALSE)
endif()
pythonize_bool(COMPILER_RT_HAS_OHOS_MEMGRAPH)
