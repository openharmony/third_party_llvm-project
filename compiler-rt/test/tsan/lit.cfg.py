...
if config.host_os == "OHOS":
    default_tsan_opts += ["ignore_noninstrumented_modules=1"]
...
config.substitutions.append(
    ("%env_tsan_opts=", "env TSAN_OPTIONS=" + default_tsan_opts_str)
)
# OHOS_LOCAL end
...
if config.host_os not in ["FreeBSD", "Linux", "Darwin", "NetBSD", "OHOS"]:
