...
static int ExpectMember(memgraph_get_member_info_fn get_member_info,
                        unsigned long expect_base, unsigned long member_addr,
...
static int VerifyPartialAndInvalidQueries(
  ...
  const int ok =
      ...
      ExpectMember(get_member_info, other_base, other_base + 8, 0, 0, nullptr,
                   nullptr, "edge member(untracked-owner-member)");
