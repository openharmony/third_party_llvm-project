...
#include <sys/msg.h>
#include <sys/ipc.h>
#endif  // SANITIZER_ANDROID || SANITIZER_OHOS || generic Linux
...
#  if !SANITIZER_ANDROID && !SANITIZER_APPLE && !SANITIZER_HAIKU && !SANITIZER_OHOS
...
#if !SANITIZER_ANDROID && !SANITIZER_HAIKU && !SANITIZER_OHOS
