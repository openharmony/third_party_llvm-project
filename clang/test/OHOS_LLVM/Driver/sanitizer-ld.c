...
// RUN:     -resource-dir=%S/../../Driver/Inputs/resource_dir \
// RUN:     --sysroot=%S/../../Driver/Inputs/basic_linux_tree \
...
// RUN:     -resource-dir=%S/../../Driver/Inputs/resource_dir \
// RUN:     --sysroot=%S/../../Driver/Inputs/basic_freebsd_tree \
...
// RUN:     -resource-dir=%S/../../Driver/Inputs/empty_resource_dir \
// RUN:     --sysroot=%S/../../Driver/Inputs/basic_linux_tree \
...
// RUN:     -resource-dir=%S/../../Driver/Inputs/resource_dir \
// RUN:     --sysroot=%S/../../Driver/Inputs/basic_linux_tree -lstdc++ -static 2>&1 \
...
// RUN:     --sysroot=%S/../../Driver/Inputs/basic_android_tree/sysroot \
...
// RUN:     -resource-dir=%S/../../Driver/Inputs/resource_dir \
// RUN:     --sysroot=%S/../../Driver/Inputs/multilib_64bit_linux_tree \
...
// RUN:     -resource-dir=%S/../../Driver/Inputs/resource_dir \
// RUN:     --sysroot=%S/../../Driver/Inputs/basic_android_tree \
// RUN:     -### %s 2>&1 \
...
// RUN:     -resource-dir=%S/../../Driver/Inputs/resource_dir \
// RUN:     --sysroot=%S/../../Driver/Inputs/ohos_native_tree/sysroot \
...
// RUN: %clang -### %s 2>&1 \
// RUN:     --target=x86_64-unknown-linux -fuse-ld=ld -fsanitize=hwaddress \
// RUN:     -shared-libsan -resource-dir=%S/../../Driver/Inputs/resource_dir \
// RUN:     --sysroot=%S/../../Driver/Inputs/basic_linux_tree \
