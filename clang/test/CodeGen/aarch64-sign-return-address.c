...
// RUN: %clang -target aarch64-arm-none-eabi -S -emit-llvm -o - -mbranch-protection=pac-ret+leaf  %s | FileCheck %s --check-prefix=CHECK --check-prefix=PAC_ALL
...
// PAC_ALL:   attributes #[[#ATTR]] = { {{.*}} "sign-return-address"
...
// PAC_ALL-NOT:   !"branch-target-enforcement"
...
// PAC_ALL:   !{i32 8, !"sign-return-address", i32 1}
...
// PAC_ALL:   !{i32 8, !"sign-return-address-all", i32 1}
...
// PAC_ALL-NOT:   !"sign-return-address-with-bkey"
