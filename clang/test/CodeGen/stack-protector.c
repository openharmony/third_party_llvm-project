...
// OHOS_LOCAL begin
// RUN: %clang_cc1 -emit-llvm -o - %s -stack-protector 4 | FileCheck -check-prefix=DEF -check-prefix=SSPRETSTRONG %s
// RUN: %clang_cc1 -emit-llvm -o - %s -stack-protector 5 | FileCheck -check-prefix=DEF -check-prefix=SSPRETREQ %s
// OHOS_LOCAL end
...
// OHOS_LOCAL begin
// RUN: %clang_cc1 -emit-llvm -o - %s -fsanitize=safe-stack -stack-protector 4 | FileCheck -check-prefix=DEF -check-prefix=SAFESTACK-SSPRETSTRONG %s
// RUN: %clang_cc1 -emit-llvm -o - %s -fsanitize=safe-stack -stack-protector 5 | FileCheck -check-prefix=DEF -check-prefix=SAFESTACK-SSPRETREQ %s
// OHOS_LOCAL end
