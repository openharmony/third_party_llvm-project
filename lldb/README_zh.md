...
LLDB（Low Level Debugger）是新一代高性能调试器。当前OpenHarmony主干分支的LLDB工具是在[llvm21.1.8](https://github.com/llvm/llvm-project/releases/tag/llvmorg-21.1.8)基础上适配演进出来的工具。支持在桌面和Openharmony设备或模拟器上调试。
