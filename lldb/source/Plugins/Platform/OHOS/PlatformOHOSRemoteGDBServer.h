...
public:
  ...
  // When 'hostname' is not ipv4, ipv6 or localhost, the function will return
  // true. e.g. IsHostnameDeviceID("127.0.0.1:8080") returns true.
...
protected:
  ...
  std::optional<HdcClient::UnixSocketNamespace> m_socket_namespace;
...
private:
  ...
  PlatformOHOSRemoteGDBServer &
  operator=(const PlatformOHOSRemoteGDBServer &other) = delete;
};
