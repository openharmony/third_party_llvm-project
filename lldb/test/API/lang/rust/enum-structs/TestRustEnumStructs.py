...
class TestRustEnumStructs(TestBase):
    ...
    def test_mixed_enum_d_none(self):
        ...
        self.assertEqual(value.getAllVariantTypes(), ["core::option::Option<>::None:32",
                                                      "core::option::Option<>::Some:32"])
    ...
    def test_option_non_null_some_pointer(self):
        type = self.target().FindFirstType("Option<core::ptr::non_null::NonNull<u64>>")
