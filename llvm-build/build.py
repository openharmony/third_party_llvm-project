...
class LlvmCore(BuildUtils):
    ...
    def build_llvm(self,
        ...
        if not self.build_config.build_only and not self.use_platform().startswith('windows'):
...
class LlvmPackage(BuildUtils):
    ...
    def darwin_stripped_xargs(self, bin_dir, necessary_bin_files, script_bins):
    ...
    def package_operation(self, build_dir, host):
        ...
        self.darwin_stripped_xargs(bin_dir, necessary_bin_files, script_bins)
