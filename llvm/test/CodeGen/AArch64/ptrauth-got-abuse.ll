...
; NOTRAP-NEXT:   ldr   x[[TMP0:[0-9]+]], [x16]
; NOTRAP-NEXT:   autia x[[TMP0]], x16
...
; NOTRAP-NEXT:   ldr   x[[TMP1:[0-9]+]], [x16]
; NOTRAP-NEXT:   autia x[[TMP1]], x16
; TRAP-NEXT:     ldr   x17, [x16]
; TRAP-NEXT:     autia x17, x16
; TRAP-NEXT:     mov   x16, x17
; TRAP-NEXT:     xpaci x16
...
; NOTRAP-NEXT:   ldr   x[[TMP2:[0-9]+]], [x16]
; NOTRAP-NEXT:   autda x[[TMP2]], x16
; TRAP-NEXT:     ldr   x17, [x16]
