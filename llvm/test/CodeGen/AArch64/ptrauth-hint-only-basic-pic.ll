...
; CHECK-ELF-NEXT:    .cfi_startproc
; CHECK-ELF-NEXT:    // %bb.0:
; CHECK-ELF:         adrp  x16, :got_auth:foo
; CHECK-ELF-NEXT:    add   x16, x16, :got_auth_lo12:foo
; CHECK-ELF-NEXT:    ldr   x17, [x16]
; CHECK-ELF-NEXT:    autia x17, x16
...
; CHECK-HINT:         adrp  x16, :got_auth:foo
; CHECK-HINT-NEXT:    add   x16, x16, :got_auth_lo12:foo
; CHECK-HINT-NEXT:    ldr   x17, [x16]
; CHECK-HINT-NEXT:    autia x17, x16
...
; CHECK-ELF-NEXT:    .cfi_startproc
; CHECK-ELF-NEXT:    // %bb.0:
; CHECK-ELF:         adrp  x16, :got_auth:var
; CHECK-ELF-NEXT:    add   x16, x16, :got_auth_lo12:var
; CHECK-ELF-NEXT:    ldr   x17, [x16]
; CHECK-ELF-NEXT:    autda x17, x16
...
; CHECK-HINT-NEXT:    .cfi_startproc
; CHECK-HINT-NEXT:    // %bb.0:
; CHECK-HINT:         adrp  x16, :got_auth:var
; CHECK-HINT-NEXT:    add   x16, x16, :got_auth_lo12:var
; CHECK-HINT-NEXT:    ldr   x17, [x16]
; CHECK-HINT-NEXT:    autda x17, x16
