...
; RUN-NOT:   -aarch64-ptrauth-auth-checks=none | FileCheck %s -DL=".L" --check-prefixes=UNCHECKED,UNCHECKED-ELF

; RUN: llc < %s -mtriple aarch64-linux-gnu -mattr=+pauth -global-isel=0                    -verify-machineinstrs \
; RUN:                                     | FileCheck %s -DL=".L" --check-prefixes=CHECKED,CHECKED-ELF
; RUN-NOT: llc < %s -mtriple aarch64-linux-gnu -mattr=+pauth -global-isel -global-isel-abort=1 -verify-machineinstrs \
; RUN-NOT:                                     | FileCheck %s -DL=".L" --check-prefixes=CHECKED,CHECKED-ELF

; RUN: llc < %s -mtriple aarch64-linux-gnu -mattr=+pauth -global-isel=0                    -verify-machineinstrs \
; RUN:   -aarch64-ptrauth-auth-checks=trap | FileCheck %s -DL=".L" --check-prefixes=TRAP,TRAP-ELF
; RUN-NOT: llc < %s -mtriple aarch64-linux-gnu -mattr=+pauth -global-isel -global-isel-abort=1 -verify-machineinstrs \
; RUN-NOT:   -aarch64-ptrauth-auth-checks=trap | FileCheck %s -DL=".L" --check-prefixes=TRAP,TRAP-ELF
...
; UNCHECKED-DARWIN-NEXT: movk x16, #65535, lsl #48
; UNCHECKED-DARWIN-NEXT: autda x17, x16
...
; CHECKED:           %bb.0:
; CHECKED-DARWIN-NEXT: mov x17, x0
; CHECKED-DARWIN-NEXT: mov x16, x1
; CHECKED-DARWIN-NEXT: movk x16, #65535, lsl #48
; CHECKED-DARWIN-NEXT: autda x17, x16
; CHECKED-DARWIN-NEXT: mov x0, x17
...
; TRAP:       %bb.0:
; TRAP-DARWIN-NEXT: mov x17, x0
; TRAP-DARWIN-NEXT: mov x16, x1
; TRAP-DARWIN-NEXT: movk x16, #65535, lsl #48
; TRAP-DARWIN-NEXT: autda x17, x16
; TRAP-DARWIN-NEXT: mov x16, x17
; TRAP-DARWIN-NEXT: xpacd x16
...
; UNCHECKED-DARWIN-NEXT: mov x16, x1
; UNCHECKED-DARWIN-NEXT: movk x16, #12345, lsl #48
; UNCHECKED-DARWIN-NEXT: autda x17, x16
; UNCHECKED-NEXT:    mov x16, x2
; UNCHECKED-NEXT:    movk x16, #56789, lsl #48
; UNCHECKED-NEXT:    pacdb x17, x16
...
; CHECKED-DARWIN-NEXT: mov x16, x1
; CHECKED-DARWIN-NEXT: movk x16, #12345, lsl #48
; CHECKED-DARWIN-NEXT: autda x17, x16
...
; CHECKED-NEXT:    mov x16, x2
; CHECKED-NEXT:    movk x16, #56789, lsl #48
; CHECKED-NEXT:    pacdb x17, x16
...
; TRAP-DARWIN-NEXT: mov x16, x1
; TRAP-DARWIN-NEXT: movk x16, #12345, lsl #48
; TRAP-DARWIN-NEXT: autda x17, x16
...
; TRAP-NEXT:    mov x16, x2
; TRAP-NEXT:    movk x16, #56789, lsl #48
; TRAP-NEXT:    pacdb x17, x16
...
; CHECKED-DARWIN-NEXT: mov x17, x0
; CHECKED-DARWIN-NEXT: autda x17, x1
; CHECKED-DARWIN-NEXT: mov x0, x17
