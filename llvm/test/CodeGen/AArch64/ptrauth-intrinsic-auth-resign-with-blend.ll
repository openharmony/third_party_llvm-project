...
; UNCHECKED-NEXT:    movk x16, #65535, lsl #48
; UNCHECKED-NEXT:    autda x17, x16
...
; CHECKED-NEXT:    movk x16, #65535, lsl #48
; CHECKED-NEXT:    autda x17, x16
...
; TRAP-NEXT:    movk x16, #65535, lsl #48
...
; UNCHECKED-NEXT:    mov x17, x0
; UNCHECKED-NEXT:    mov x16, x1
; UNCHECKED-NEXT:    movk x16, #12345, lsl #48
; UNCHECKED-NEXT:    autda x17, x16
...
; CHECKED-NEXT:    mov x17, x0
; CHECKED-NEXT:    mov x16, x1
; CHECKED-NEXT:    movk x16, #12345, lsl #48
; CHECKED-NEXT:    autda x17, x16
...
; TRAP-NEXT:    mov x17, x0
; TRAP-NEXT:    mov x16, x1
; TRAP-NEXT:    movk x16, #12345, lsl #48
; TRAP-NEXT:    autda x17, x16
; TRAP-NEXT:    mov x16, x17
; TRAP-NEXT:    xpacd x16
; TRAP-NEXT:    cmp x16, x17
