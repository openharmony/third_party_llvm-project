...
; RUN-NOT: llc < %s -mtriple arm64e-apple-darwin -global-isel=0                    -verify-machineinstrs \
; RUN-NOT:   -aarch64-ptrauth-auth-checks=none | FileCheck %s -DL="L" --check-prefixes=UNCHECKED,UNCHECKED-DARWIN
; RUN-NOT: llc < %s -mtriple arm64e-apple-darwin -global-isel -global-isel-abort=1 -verify-machineinstrs \
; RUN-NOT:   -aarch64-ptrauth-auth-checks=none | FileCheck %s -DL="L" --check-prefixes=UNCHECKED,UNCHECKED-DARWIN

; RUN-NOT: llc < %s -mtriple arm64e-apple-darwin -global-isel=0                    -verify-machineinstrs \
; RUN-NOT:                                     | FileCheck %s -DL="L" --check-prefixes=CHECKED,CHECKED-DARWIN
; RUN-NOT: llc < %s -mtriple arm64e-apple-darwin -global-isel -global-isel-abort=1 -verify-machineinstrs \
; RUN-NOT:                                     | FileCheck %s -DL="L" --check-prefixes=CHECKED,CHECKED-DARWIN

; RUN-NOT: llc < %s -mtriple arm64e-apple-darwin -global-isel=0                    -verify-machineinstrs \
; RUN-NOT:   -aarch64-ptrauth-auth-checks=trap | FileCheck %s -DL="L" --check-prefixes=TRAP,TRAP-DARWIN
; RUN-NOT: llc < %s -mtriple arm64e-apple-darwin -global-isel -global-isel-abort=1 -verify-machineinstrs \
; RUN-NOT:   -aarch64-ptrauth-auth-checks=trap | FileCheck %s -DL="L" --check-prefixes=TRAP,TRAP-DARWIN
...
; UNCHECKED-DARWIN-NEXT: autia x17, x1
...
; UNCHECKED:           %bb.0:
; UNCHECKED-DARWIN-NEXT: mov x17, x0
; UNCHECKED-DARWIN-NEXT: autiza x17
; UNCHECKED-DARWIN-NEXT: mov x0, x17
...
; UNCHECKED:           %bb.0:
; UNCHECKED-DARWIN-NEXT: mov x17, x0
; UNCHECKED-DARWIN-NEXT: autib x17, x1
; UNCHECKED-DARWIN-NEXT: mov x0, x17
...
; UNCHECKED:           %bb.0:
; UNCHECKED-DARWIN-NEXT: mov x17, x0
; UNCHECKED-DARWIN-NEXT: autizb x17
; UNCHECKED-DARWIN-NEXT: mov x0, x17
...
; UNCHECKED:           %bb.0:
; UNCHECKED-DARWIN-NEXT: mov x17, x0
; UNCHECKED-DARWIN-NEXT: autda x17, x1
; UNCHECKED-DARWIN-NEXT: mov x0, x17
...
; UNCHECKED:           %bb.0:
; UNCHECKED-DARWIN-NEXT: mov x17, x0
; UNCHECKED-DARWIN-NEXT: autdza x17
; UNCHECKED-DARWIN-NEXT: mov x0, x17
...
; UNCHECKED:           %bb.0:
; UNCHECKED-DARWIN-NEXT: mov x17, x0
; UNCHECKED-DARWIN-NEXT: autdb x17, x1
; UNCHECKED-DARWIN-NEXT: mov x0, x17
...
; UNCHECKED:           %bb.0:
; UNCHECKED-DARWIN-NEXT: mov x17, x0
; UNCHECKED-DARWIN-NEXT: autdzb x17
; UNCHECKED-DARWIN-NEXT: mov x0, x17
...
; UNCHECKED-NEXT:    autia x17, x1
; UNCHECKED-NEXT:    pacia x17, x2
...
; CHECKED:       %bb.0:
; CHECKED-NEXT:    mov x17, x0
; CHECKED-NEXT:    autda x17, x1
; CHECKED-NEXT:    mov x16, x17
; CHECKED-NEXT:    xpacd x16
; CHECKED-NEXT:    cmp x16, x17
...
; UNCHECKED:       %bb.0:
; UNCHECKED-NEXT:    mov x17, x0
; UNCHECKED-NEXT:    autdb x17, x1
; UNCHECKED-NEXT:    pacda x17, x2
; UNCHECKED-NEXT:    mov x0, x17
; UNCHECKED-NEXT:    ret
;
...
; UNCHECKED:       %bb.0:
; UNCHECKED-NEXT:    mov x17, x0
; UNCHECKED-NEXT:    autiza x17
; UNCHECKED-NEXT:    pacdb x17, x2
; UNCHECKED-NEXT:    mov x0, x17
; UNCHECKED-NEXT:    ret
;
...
; UNCHECKED:           %bb.0:
; UNCHECKED-DARWIN-NEXT: mov x17, x0
; UNCHECKED-DARWIN-NEXT: mov x16, #256
; UNCHECKED-DARWIN-NEXT: autia x17, x16
; UNCHECKED-DARWIN-NEXT: mov x0, x17
...
; UNCHECKED-NEXT:    mov x17, x0
; UNCHECKED-NEXT:    autda x17, x1
; UNCHECKED-NEXT:    mov x16, #256
; UNCHECKED-NEXT:    pacda x17, x16
; UNCHECKED-NEXT:    mov x0, x17
; UNCHECKED-NEXT:    ret
;
...
; CHECKED-NEXT:    mov x16, #256
; CHECKED-NEXT:    pacda x17, x16
...
; TRAP-NEXT:    mov x16, #256
; TRAP-NEXT:    pacda x17, x16
; TRAP-NEXT:    mov x0, x17
; TRAP-NEXT:    ret
...
; UNCHECKED-DARWIN-NEXT: autia x17, x0
; UNCHECKED-DARWIN-NEXT: mov x0, x17
...
; UNCHECKED-DARWIN-NEXT:        ldr     x8, [x17]
