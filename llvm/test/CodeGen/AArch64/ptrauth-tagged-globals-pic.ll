...
; RUN:   -mattr=+pauth              | FileCheck %s --check-prefixes=CHECK,DAGISEL
...
; RUN:   -mattr=+pauth              | FileCheck %s --check-prefixes=CHECK,GISEL
...
; CHECK:               adrp  x17, :got_auth:global
; CHECK-NEXT:          add   x17, x17, :got_auth_lo12:global
; GISEL-NEXT:          ldr   x8,  [x17]
; GISEL-NEXT:          autda x8,  x17
; DAGISEL-NEXT:        ldr   x9,  [x17]
; DAGISEL-NEXT:        autda x9,  x17
