; REQUIRES: ohos_llvm
;; OHOS_LOCAL: ImplicitNullChecks with AArch64 ptr addrspace(271)
;; TODO: Remove UNSUPPORTED until  ptr32 ImplicitNullChecks fixed
; UNSUPPORTED: true
; RUN: llc --enable-implicit-null-checks -verify-machineinstrs -O2 < %s | FileCheck %s
