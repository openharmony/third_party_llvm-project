...
// Verify PAC and MIU compatibility scenario.
// The MIU function generates an additional COPY instruction between the AUTCALL and BLR instructions.
TEST(EarlyPartsCpi, MIUCompatibility) {
...
body: |
  ...
  bb.1:
    ; predecessors: %bb.0
    %6:gpr32 = MOVi32imm 22545
    %7:gpr64sp = SUBREG_TO_REG 0, killed %6:gpr32, %subreg.sub_32
    %8:gpr64 = PARTS_AUTCALL %58:gpr64, killed %7:gpr64sp
    $x0 = COPY %8:gpr64
    %9:gpr64 = COPY $x0
