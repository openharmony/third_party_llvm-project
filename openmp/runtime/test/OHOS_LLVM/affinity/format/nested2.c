// REQUIRES: ohos_llvm
// RUN: %libomp-compile && env OMP_DISPLAY_AFFINITY=true OMP_PLACES=threads OMP_PROC_BIND=spread,close KMP_HOT_TEAMS_MAX_LEVEL=2 KMP_WARNINGS=false %libomp-run | %python %S/../../../affinity/format/check.py -c 'CHECK' %s
